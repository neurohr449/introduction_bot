...
async def get_table_data(sheet_id, sheet_range, state: FSMContext,):
    ...
    await state.update_data(
        ...
        chat_id=row_data[4],
        block_id=row_data[5],
        modile_id=row_data[6],
        video_block=row_data[7],
        video_module=row_data[8],
        ...
        promt=row_data[64],
        promt_2=row_data[65],
        target_score = row_data[66],
        test_tiser=row_data[67],
        processing_answers=row_data[68],
        result_yes=row_data[69],
        result_no=row_data[70],
        confurmation_message=[71],
        notification_pd=row_data[72],
